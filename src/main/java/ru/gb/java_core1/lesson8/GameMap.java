package ru.gb.java_core1.lesson8;
    ...
    private void update(MouseEvent e) {
        ...
        if(gameMode == 0){
            ...
            if(playerNumTurn % 2 == 0) {
                ...
                if (gameCheck(DOT_PLAYER2, STATE_WIN_HUMAN2)) {
                    return;
                }
        ...
        for (int y = 0; y < fieldSizeY; y++) {
            for (int x = 0; x < fieldSizeX; x++) {
                ...
                if (field[y][x] == DOT_HUMAN) {
                    ...
                    g.drawLine(x * cellWidth + DOT_PADDING + 1,     // не нашел как сделать толстыми линии,
                            y * cellHeight + DOT_PADDING,               // поэтому просто продублировал их на 1пиксель
                            (x + 1) * cellWidth  - DOT_PADDING + 1 ,
                            (y + 1) * cellHeight - DOT_PADDING );
                    g.drawLine(x * cellWidth + DOT_PADDING - 1,
                            y * cellHeight + DOT_PADDING,
                            (x + 1) * cellWidth  - DOT_PADDING - 1 ,
                            (y + 1) * cellHeight - DOT_PADDING );
                    ...
                    g.drawLine((x + 1) * cellWidth  - DOT_PADDING ,
                            y * cellHeight + DOT_PADDING ,
                            x * cellWidth  + DOT_PADDING ,
                            (y + 1) * cellHeight - DOT_PADDING);
                    g.drawLine((x + 1) * cellWidth  - DOT_PADDING + 1 ,
                            y * cellHeight + DOT_PADDING ,
                            x * cellWidth  + DOT_PADDING + 1,
                            (y + 1) * cellHeight - DOT_PADDING);
                    g.drawLine((x + 1) * cellWidth  - DOT_PADDING - 1 ,
                            y * cellHeight + DOT_PADDING ,
                            x * cellWidth  + DOT_PADDING - 1,
                    ...
                    g.fillOval(x * cellWidth + DOT_PADDING*2,
